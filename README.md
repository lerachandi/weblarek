...
- `addIaddProducttem(product: IProduct): void` - добавление товара
- `removeProduct(product: IProduct): void` - удаление товара
- `clearBasket(): void` - очистка корзины
- `getTotalCost(): number` - общая стоимость товаров в корзине
- `getProductCount(): number` - общее количество товаров в корзине
...
- `setPasetPaymentMethodyment(method: TPayment): void` - устанавливает способ оплаты
